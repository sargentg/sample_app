...
describe User do
  ...
  it "should reject email addrersses idential up to case" do
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      it "should return nill on email/password mismatch" do
        wrong_password_user = User.authenticate(@attr[:email], :password => "wrongpass")
        wrong_password_user.should be_nil
      end
      
      it "should return nill for email address with no user" do
